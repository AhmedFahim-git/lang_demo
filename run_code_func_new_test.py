...
# user_session{expiry_time:datetime, popen:popen, tempdir:tempdir}
POPEN_DICT = {}
...
async def run_code(code_info: CodeInfo):
    ...
    key = f"{code_info.userid}_{code_info.sessionid}"
    if key in POPEN_DICT:
        my_temp_dir = POPEN_DICT[key]["tempdir"]
